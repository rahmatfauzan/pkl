                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Modal Hapus -->
                                    <div class="modal fade" id="hapusModal{{ $category->id }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Apakah Anda yakin ingin menghapus category dengan nama
                                                    {{ $category->name }}?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <form action="{{ route('category.hapus', $category->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('category.tambah') }}">
                    <div class="modal-body">
                        @csrf
                        <div class="form-group">
                            <label for="name">Nama</label>
